...
% Channel Names
chz_vec = 'HHZ'; % list of acceptable names for Z component
ch1_vec = 'HH1'; % list of acceptable names for H1 component
ch2_vec = 'HH2'; % list of acceptable names for H2 component
...
chanlist = sprintf('%s,%s',ch1_vec,ch2_vec);
